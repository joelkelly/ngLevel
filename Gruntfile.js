  ...
  var taskConfig = {
    ...
    concat: {
      ...
      build_css: {
        src: [
          '<%= vendor_files.css %>',
          '<%= build_dir %>/assets/styles/<%= pkg.name %>-<%= pkg.version %>.css'
        ],
      ...
      compile_js: {
        ...
        dest: '<%= compile_dir %>/assets/scripts/<%= pkg.name %>-<%= pkg.version %>.js'
      }
    },
    ...
    sass: {
      ...
      build: {
        files: {
          '<%= build_dir %>/assets/styles/<%= pkg.name %>-<%= pkg.version %>.css': '<%= app_files.sass %>'
        },
        options: {
          style: 'expanded'
        }
